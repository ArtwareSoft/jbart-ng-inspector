(function() {
	...
	angular.module('jbartInspector',['ng']).run(function($rootScope,$compile, $parse,$templateCache) {
...
//		console.log('module loaded - ' + name);
		 if (requires && name.indexOf('ng') != 0)		
		 	return prevFunc.call(angular,name,requires.concat(['jbartInspector']),configFN);
		 else
